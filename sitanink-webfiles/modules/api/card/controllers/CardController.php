...
class CardController extends BaseController
{
    ...
    public function getData()
    {
        ...
        foreach ($data as $item) {
            ...
            $row[]  = "<div class=\"text-center\">
                            <a onclick=\"javascript:void(0)\" class=\"btn btn-primary btn-xs mr-2\"><i class=\"fa fa-print\"></i>&nbsp;Print</a>
                            ...
                            <a href=\"#\" class=\"btn btn-info btn-xs mr-2\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp;Edit</a>
    ...
    public function generate()
    {
        ...
        // remove generated preview by pekerja nik
