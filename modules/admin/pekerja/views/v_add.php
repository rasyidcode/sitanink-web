                ...
                <div class="box-body">
                    <form id="form-add-pekerja" action="<?= route_to('pekerja.create') ?>" method="POST" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block">Ukuran 3x4, max. <strong>500 KB</strong></p>
                        </div>
                        <div class="form-group">
                            <label for="foto">Scan KTP</label>
                            <input type="file" id="scan-ktp" name="scan_ktp">
                            <p class="help-block">Max. <strong>1 MB</strong></p>
                        </div>
                        <div class="form-group">
                            <label for="foto">Surat Pernyataan</label>
                            <input type="file" id="surat-pernyataan" name="surat-pernyataan">
                            <p class="help-block">Max. <strong>1 MB</strong></p>
                        </div>
                        <div class="form-group">
