                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group <?= isset($fdErr['number']) ? 'has-error' : '' ?>">
                                            ...
                                            <input type="text" name="number" class="form-control" placeholder="Masukkan Nomor Surat ..." value="<?= old('number', $dataEdit->number) ?? '' ?>">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group <?= isset($fdErr['year']) ? 'has-error' : '' ?>">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="year" class="form-control pull-right" value="<?= $dataEdit->year ?>" id="year-picker" placeholder="Masukkan Tahun Surat...">
                                            </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group <?= isset($fdErr['valid_until']) ? 'has-error' : '' ?>">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="valid_until" class="form-control pull-right" value="<?= $dataEdit->valid_until ?>" id="valid-until-picker" placeholder="Masukkan Berlaku Sampai...">
                                            </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group <?= isset($fdErr['set_date']) ? 'has-error' : '' ?>">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="set_date" class="form-control pull-right" value="<?= $dataEdit->set_date ?>" id="set-date-picker" placeholder="Masukkan Tanggal Surat Ditetapkan...">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="attachments_view" class="form-control select2" multiple="multiple" data-placeholder="Pilih Pekerja Yang Akan Dilampirkan" style="width: 100%;">
                                                <?php foreach ($listPekerja as $itemPekerja) : ?>
                                                    <option value="<?= $itemPekerja->id ?>" <?= in_array($itemPekerja->id, $attachmentsEdit) ? 'selected' : '' ?>><?= $itemPekerja->nama . ' [' . $itemPekerja->nik . ']' ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <input type="hidden" name="attachments" value="<?= implode(',', $attachmentsEdit) ?>">
