        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header">
                    <a href="<?= route_to('domisili.add') ?>" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Domisili</a>
                ...
                <div class="box-body">
                    <div class="dataTables_wrapper form-inline dt-bootstrap">
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="data-domisili" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    <thead>
                                        <tr role="row">
                                            <th>#</th>
                                            <th>Nama</th>
    ...
    $(function() {
        $('#data-domisili').DataTable({
            ...
            ajax: function(data, callback, settings) {
                ...
                $.ajax({
                    type: 'post',
                    url: '<?= route_to('api.domisili.get-data') ?>',
                    data: data,
