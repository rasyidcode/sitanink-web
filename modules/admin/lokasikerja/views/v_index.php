        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header">
                    <a href="<?= route_to('lokasi-kerja.add') ?>" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Lokasi Kerja</a>
                ...
                <div class="box-body">
                    <div class="dataTables_wrapper form-inline dt-bootstrap">
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="data-lokasi-kerja" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    <thead>
                                        <tr role="row">
                                            <th>#</th>
                                            <th>Nama Lokasi</th>
    ...
    $(function() {
        $('#data-lokasi-kerja').DataTable({
            ...
            ajax: function(data, callback, settings) {
                ...
                $.ajax({
                    type: 'post',
                    url: '<?= route_to('api.lokasi-kerja.get-data') ?>',
                    data: data,
        ...
        // delete user
        $('#data-lokasi-kerja tbody').on('click', 'tr td button.btn.btn-danger', function(e) {
            var lokasiKerjaId = $(this).data().lokasiKerjaId;
            var baseUrl = window.location.href;
            
            if (confirm('Anda yakin mau dihapus?')) {
                $.ajax({
                    url: baseUrl+'/'+lokasiKerjaId+'/delete',
                    type: 'post',
                    data: {
                        ['<?= csrf_token() ?>']: '<?= csrf_hash() ?>'
                    },
        ...
        $('#data-lokasi-kerja tbody').on('click', 'tr td a.btn.btn-success', function(e) {
